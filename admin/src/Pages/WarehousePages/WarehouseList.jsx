...
const WarehouseList = () => {
  ...
  const deleteWarehouse = async (id) => {
    ...
    try {
      await axios.delete(
        `https://ecommerceclone1.onrender.com/api/warehouse/delete/${id}`
      );
  ...
  const fetchWarehouses = async () => {
    try {
      const res = await axios.get(
        "https://ecommerceclone1.onrender.com/api/warehouse/list"
                ...
                onClick={async () => {
                  ...
                  try {
                    if (editingWarehouse) {
                      // 🔄 EDIT
                      await axios.put(
                        `https://ecommerceclone1.onrender.com/api/warehouse/update/${editingWarehouse.id}`,
                        form
                      );
                    } else {
                      // ➕ ADD
                      await axios.post(
                        "https://ecommerceclone1.onrender.com/api/warehouse/add",
                        form
                      );
                    }
                    await fetchWarehouses();
