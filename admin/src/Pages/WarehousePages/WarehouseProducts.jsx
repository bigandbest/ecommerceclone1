...
const WarehouseProducts = () => {
  ...
  const fetchWarehouse = async () => {
    const res = await axios.get(`https://ecommerceclone1.onrender.com/api/warehouse/listsingle/${id}`);
    setWarehouse(res.data);
  };

  // Fetch products mapped to this warehouse
  const fetchWarehouseProducts = async () => {
    const res = await axios.get(`https://ecommerceclone1.onrender.com/api/productwarehouse/warehouse/${id}`);
  ...
  const handleAddProduct = async () => {
    ...
    try {
      await axios.post("https://ecommerceclone1.onrender.com/api/productwarehouse/map", {
  ...
  const handleRemoveProduct = async (product_id) => {
    try {
      await axios.post("https://ecommerceclone1.onrender.com/api/productwarehouse/remove", {
        product_id,
        warehouse_id: parseInt(id),
      });
      await fetchWarehouseProducts();
