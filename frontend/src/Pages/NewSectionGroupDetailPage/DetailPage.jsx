...
                        break;
                    case 'saving-zone':
                        setPageTitle('Saving Zone');
                        fetchedGroups = await getGroupsBySavingZoneId(id);
                        break;
                    case 'quick-pick':
                    default:
...
                        break;
                    case 'saving-zone':
                        fetchedProducts = await getProductsForSavingZoneGroup(selectedGroup.id);
                        break;
                    case 'quick-pick':
                    default:
